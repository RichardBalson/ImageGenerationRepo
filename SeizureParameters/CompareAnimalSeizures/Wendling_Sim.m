...
SimulationSettings.fs = fs;
    ...
    SimulationSettings.number_of_sigma_input = 12; % Used to determine standard deviation of input if  1: 68.27% of realisations within physiolgical range, 2: 95.45, 3: 99.73 4: 99.994
